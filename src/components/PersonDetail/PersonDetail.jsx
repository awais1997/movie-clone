...
const PersonDetail = ({personDetail}) => {
  return (
    ...
    <Card className="PersonDetail-card"  style={{backgroundColor: "#032541"}}>
      <div className="PersonDetail-image" >
         <img src={`https://image.tmdb.org/t/p/w220_and_h330_face${personDetail.profile_path}`} alt={personDetail.title}/>
      </div>
      <div class="PersonDetail-content">
        ...
        <h4>Gender</h4>{personDetail.gender !== 1 ? "Male":"Female"}
         <h2>Biography</h2> <p>{personDetail.biography}</p>
        <h5>Popularity</h5>{personDetail.popularity}
        <h5>Place of Birth</h5>{personDetail.place_of_birth}
